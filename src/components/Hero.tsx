  ...
  return (
    <section className="relative overflow-hidden max-w-full">
      ...
      <div className="relative max-w-7xl mx-auto px-6 pt-40 pb-24 md:pt-52 md:pb-32">
        ...
        <h1
          className="font-display font-extrabold text-[clamp(2rem,7.5vw,3rem)] md:text-6xl lg:text-7xl leading-[1.05] tracking-tight w-[calc(100vw-3rem)] sm:w-auto max-w-full sm:max-w-4xl break-words"
        >
        ...
        <p
          className="mt-6 text-lg md:text-xl text-muted-foreground w-[calc(100vw-3rem)] sm:w-auto max-w-full sm:max-w-2xl leading-relaxed"
        >
